      ...
      <div className="container-custom">
        <div className="flex items-center justify-between h-14 lg:h-16">
          ...
          <div className="hidden lg:flex items-center gap-2">
              ...
              {navigation.map((item, index) => (
                ...
                >
                  {item.children ? (
                    ...
                    <Button
                      asChild
                      className="bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))]/90 text-[hsl(var(--primary-foreground))] border-0 shadow-sm hover:shadow-md font-semibold text-sm px-4 py-2 rounded-lg"
                    >
            ...
            <Button
              asChild
              className="ml-1 bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))]/90 text-[hsl(var(--primary-foreground))] border-0 shadow-md hover:shadow-lg font-semibold text-base px-4 py-2.5 rounded-lg"
            >
              <Link href="/demo">
            ...
            >
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[hsl(var(--muted-foreground))]">
                      Explore <span className="text-primary">intelli</span>
              ...
              <div className="px-4 py-3 space-y-1">
                    ...
                    {item.children ? (
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          <motion.div
                            animate={{
                              rotate: activeDropdown === item.label ? 90 : 0,
                            }}
                            transition={{ duration: 0.2 }}
                          >
                          ...
                          {activeDropdown === item.label && (
                            ...
                            >
                              {item.children.map((column, colIndex) => (
                                <div
                                  key={column.label}
                                  className="border-b border-[hsl(var(--border))]/50 last:border-b-0"
                                >
                ...
                >
                  <Button
                    asChild
                    className="w-full bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))]/90 text-[hsl(var(--primary-foreground))] border-0 font-semibold text-base py-3 rounded-lg shadow-md"
                  >
