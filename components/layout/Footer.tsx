...
const socialLinks = [
  { name: 'LinkedIn', href: 'https://linkedin.com/company/pk-companies', icon: Linkedin },
  { name: 'Twitter', href: 'https://twitter.com/pkcompanies', icon: Twitter },
  { name: 'Facebook', href: 'https://facebook.com/pkcompanies', icon: Facebook },
  { name: 'Instagram', href: 'https://instagram.com/pkcompanies', icon: Instagram },
]
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-slate-600 mb-6 leading-relaxed">
                The most modern, trusted, and field-ready industrial platform for inspections, safety, and turnarounds.
              </p>
              ...
              <ul className="space-y-2">
                {footerLinks.solutions.map((link) => (
                  <li key={link.name} className="flex items-center gap-2">
                    {link.icon && <link.icon className="w-4 h-4 text-slate-500" aria-hidden="true" />}
                    <Link 
                      href={link.href}
                    ...
                    >
                      {link.nameParts ? (
                        <>
                          {link.nameParts.prefix}<span className="font-bold">{link.nameParts.suffix}</span>
                        </>
                      ) : link.name}
                    </Link>
                  </li>
        ...
        <div className="py-8 border-t border-slate-300/30">
          <div className="glass-morphism rounded-2xl p-8 text-center">
            <div className="flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900">Stay Updated</h3>
            </div>
            <p className="text-slate-600 mb-6 max-w-md mx-auto">
              Get the latest insights on industrial technology, safety innovations, and IntelliSpec updates.
            </p>
        ...
        <div className="py-8 border-t border-slate-300/30">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 text-sm text-slate-500">
              <span>&copy; 2024 IntelliSpec. All rights reserved.</span>
              <Link href="/privacy" className="hover:text-slate-900:text-white transition-colors duration-200">
                Privacy Policy
              </Link>
              <Link href="/terms" className="hover:text-slate-900:text-white transition-colors duration-200">
                Terms of Service
              </Link>
              <Link href="/cookies" className="hover:text-slate-900:text-white transition-colors duration-200">
                Cookie Policy
              </Link>
            </div>
