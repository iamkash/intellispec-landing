...
const metrics: Metric[] = [
  {
    ...
    description: 'Reduced inspection time from days to hours with digital workflows',
    icon: Clock,
...
function AnimatedCounter({ value, suffix }: { value: number; suffix: string }) {
  ...
  return (
    <span ref={ref} className="text-3xl md:text-4xl font-bold text-[hsl(var(--foreground))]">
      {count}{suffix}
    </span>
  )
}
      ...
      <div className="container-custom">
        ...
        >
          <div className="inline-flex items-center px-4 py-2 glass-morphism rounded-full text-sm font-medium mb-6">
            ...
            <span className="text-[hsl(var(--foreground))]">Market-Leading Results</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-[hsl(var(--foreground))] mb-6">
            Results That <span className="text-[hsl(var(--primary))]">Dominate the Market</span>
          </h2>
          <p className="text-xl text-[hsl(var(--muted-foreground))] max-w-4xl mx-auto leading-relaxed">
            Measurable results from real implementations across industries. See how IntelliSpec consistently outperforms competitors
            <span className="font-semibold text-[hsl(var(--foreground))]"> by 20-40% across all metrics</span> and delivers quantifiable ROI.
          </p>
        </motion.div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[hsl(var(--muted-foreground))]">Consistently outperform industry averages by 20-40%</p>
                </div>
              </div>
              <div className="flex items-center gap-6">
                <div className="text-center">
                  <div className="text-2xl font-bold text-[hsl(var(--primary))]">50+</div>
                  <div className="text-sm text-[hsl(var(--muted-foreground))]">Fortune 500 Companies</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-[hsl(var(--accent))]">100%</div>
                  <div className="text-sm text-[hsl(var(--muted-foreground))]">Compliance Rate</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-[hsl(var(--secondary))]">4-6</div>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="text-center">
                  ...
                  <h4 className="text-xl font-semibold text-[hsl(var(--foreground))] mb-3">Market Leadership</h4>
                  <p className="text-base text-[hsl(var(--muted-foreground))]">
                    Real results from 50+ industrial facilities with 20-40% better performance than competitors.
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-xl font-semibold text-[hsl(var(--foreground))] mb-3">Rapid Implementation</h4>
                  <p className="text-base text-[hsl(var(--muted-foreground))]">
                    Average deployment time of 4-6 weeks with immediate productivity gains and cost savings.
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-xl font-semibold text-[hsl(var(--foreground))] mb-3">Risk-Free Start</h4>
                  <p className="text-base text-[hsl(var(--muted-foreground))]">
                    Start with a pilot program and scale based on proven results and measurable outcomes.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-[hsl(var(--muted))]/50 rounded-xl p-6 mb-8 border border-[hsl(var(--border))]">
                ...
                <div className="grid md:grid-cols-2 gap-6 text-left">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-base font-semibold text-[hsl(var(--foreground))]">20-40% better performance</p>
                      <p className="text-sm text-[hsl(var(--muted-foreground))]">Consistently outperform industry averages across all metrics</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-3 h-3 bg-[hsl(var(--accent))] rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <p className="text-base font-semibold text-[hsl(var(--foreground))]">Industry-specific expertise</p>
                      <p className="text-sm text-[hsl(var(--muted-foreground))]">Built by industrial experts, not generic software developers</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-3 h-3 bg-[hsl(var(--primary))] rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <p className="text-base font-semibold text-[hsl(var(--foreground))]">Proven track record</p>
                      <p className="text-sm text-[hsl(var(--muted-foreground))]">50+ Fortune 500 companies trust IntelliSpec</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-3 h-3 bg-[hsl(var(--secondary))] rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <p className="text-base font-semibold text-[hsl(var(--foreground))]">Rapid time-to-value</p>
                      <p className="text-sm text-[hsl(var(--muted-foreground))]">See results in 4-6 weeks vs. 6-12 months with competitors</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <p className="text-base text-[hsl(var(--muted-foreground))] mb-8 max-w-4xl mx-auto leading-relaxed">
                <strong>Don&apos;t wait to see these results in your operations.</strong> Join the 50+ facilities that have already transformed
                their processes with IntelliSpec and are seeing
                <span className="font-semibold text-[hsl(var(--primary))]"> 20-40% better results than their competitors.</span>
                Calculate your potential ROI and see exactly how much you could save.
              </p>

              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <Button asChild className="bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))]/90 text-[hsl(var(--primary-foreground))] border-0 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 font-bold text-lg px-12 py-4">
                  <Link href="/pricing">
                    <span>See Pricing & Estimate ROI</span>
                    <ArrowRight className="w-5 h-5 ml-3" />
                  </Link>
                </Button>
                <Button asChild variant="outline" className="border-[hsl(var(--primary))] text-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))]/5 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 font-bold text-lg px-12 py-4">
                  <Link href="/demo">
