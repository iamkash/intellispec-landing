          ...
          <div className="container-custom relative z-10">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto mb-8 leading-relaxed">
                Experience how our <span className="text-primary font-semibold">10 precision-engineered modules</span> transform industrial operations. 
                From <span className="text-primary font-semibold">intelliINSPECT</span> and <span className="text-primary font-semibold">intelliNDT</span> to <span className="text-primary font-semibold">intelliVISION</span> and <span className="text-primary font-semibold">intelliSAFETY</span> - discover how our complete integrated platform can revolutionize your business.
              </p>
          ...
          <div className="container-custom">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                What to Expect in Your <span className="gradient-text">Demo</span>
              </h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Our demos are designed to show you exactly how IntelliSpec can solve your specific challenges with <span className="text-primary font-semibold">live data</span> and <span className="text-primary font-semibold">real workflows</span>.
              </p>
            </motion.div>
          ...
          <div className="container-custom">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
                Get a quick overview of our <span className="text-primary font-semibold">10 integrated modules</span> before your personalized demo.
              </p>
            </motion.div>
            ...
            >
              <div className="aspect-video bg-gradient-to-br from-muted/50 to-muted/80 rounded-2xl shadow-2xl flex items-center justify-center glass-card">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-foreground mb-2">IntelliSpec Platform Overview</h3>
                  <p className="text-muted-foreground mb-4">Watch our comprehensive platform walkthrough</p>
        ...
        <section id="schedule" className="section-padding bg-primary/5">
          <div className="container-custom">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Choose your preferred time and we&apos;ll customize the demo for your specific needs and industry.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                  ...
                  {contactMethods.map((method, index) => (
                    ...
                    >
                      <div className="flex items-start space-x-4">
                        <div className={`w-12 h-12 bg-gradient-to-br ${method.color} rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg`}>
                          <method.icon className="w-6 h-6 text-white" />
                        </div>
                        <div className="flex-1">
                          <h4 className="text-lg font-semibold text-foreground mb-2">{method.title}</h4>
                          <p className="text-muted-foreground mb-3">{method.description}</p>
                          <Link href={method.href} className="btn-primary inline-flex items-center">
              ...
              >
                <h3 className="text-2xl font-bold text-foreground mb-6">Quick Schedule</h3>
                <div className="space-y-6">
                  <div>
          ...
          <div className="container-custom">
            ...
            >
              ...
              <p className="text-xl text-primary-foreground/80 mb-8 max-w-3xl mx-auto">
                Join hundreds of companies that have already transformed their industrial operations with our <span className="text-white font-semibold">10 integrated modules</span>. Experience the difference today.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="#schedule" className="inline-flex items-center px-8 py-4 bg-white text-primary font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 text-lg">
                  <span>Schedule Your Demo</span>
                  <ArrowRight className="w-5 h-5 ml-2" />
                </Link>
                <Link href="/contact" className="inline-flex items-center px-8 py-4 border-2 border-white text-white font-semibold rounded-xl hover:bg-white hover:text-primary transition-all duration-300 text-lg">
