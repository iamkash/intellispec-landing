...
const features = [
  {
    ...
    description:
      "Choose only the modules you need. Start small and scale as your operations grow.",
  },
  {
    icon: Shield,
    title: "Scalable Solution",
    description:
      "From single-site operations to multi-plant enterprises, intelliSPEC grows with you.",
  },
  {
    icon: Settings,
    title: "Flexible Implementation",
    description:
      "Deploy at your own pace. Integrate with existing systems or start fresh.",
  },
];
...
const modules = [
  {
    name: "intelliINSPECT",
    description:
      "AI-powered digital inspection workflows: mobile forms, data capture, automated analysis",
    icon: Search,
    features: [
  ...
  },
  {
    name: "intelliNDT",
    description:
      "AI-powered non-destructive testing QA: auto-tag indications, coverage maps, reporting",
    icon: Shield,
    features: [
  ...
  },
  {
    ...
    description:
      "AI-powered mechanical/asset integrity: RBI, corrosion monitoring, predictive dashboards",
    icon: Settings,
    features: [
      "Risk assessment",
      "Asset monitoring",
  ...
  },
  {
    name: "intelliTURN",
    description:
      "AI-powered turnaround management: planning, scheduling, risk alerts",
    icon: Calendar,
    features: [
      "Project planning",
      "Resource allocation",
  ...
  },
  {
    name: "intelliWORK",
    description:
      "AI-powered crew management/workforce orchestration: plan crews, assign shifts, track productivity",
    icon: Briefcase,
    features: [
      "Work order creation",
      "Task assignment",
  ...
  },
  {
    name: "intelliTRACK",
    description:
      "AI-powered real-time asset tracking software: location, utilization, loss prevention",
    icon: MapPin,
    features: [
      "Asset lifecycle",
      "Location tracking",
  ...
  },
  {
    name: "intelliCOMPLY",
    description:
      "AI-powered automated compliance: policy tracking, evidence vault, audit prep",
    icon: FileText,
    features: [
  ...
  },
  {
    name: "intelliSAFETY",
    description:
      "AI-powered safety command & control: incident prediction, emergency response",
    icon: Shield,
    features: [
      "Emergency protocols",
      "Communication tools",
  ...
  },
  {
    name: "intelliSCAFF",
    description:
      "AI-powered scaffolding management: material usage, cost tracking, compliance",
    icon: Database,
    features: [
      "Secure storage",
      "Data encryption",
  ...
  },
  {
    name: "intelliVISION",
    description:
      "AI-powered cross-module analytics: predictive insights, unified KPIs",
    icon: Eye,
    features: [
      "Predictive analytics",
...
const plans = [
  {
    ...
    description:
      "Core for inspections. Fast. Accurate. Compliant. Includes digital forms, automated evidence capture, and audit‑ready records.",
    ...
    modules: ["intelliINSPECT", "intelliNDT", "intelliINTEGRITY"],
  },
  {
    name: "IntelliEdge",
    tagline: "Complete operational intelligence",
    description:
      "Plan and execute faster. Data‑driven decisions. Turnaround planning, workforce orchestration, and asset tracking in one command view.",
    ...
    modules: ["intelliTURN", "intelliWORK", "intelliTRACK"],
  },
  {
    name: "IntelliEnterprise",
    tagline: "Enterprise-wide transformation",
    description:
      "Full facility intelligence. Secure. Scalable. Predictive. Multi‑site governance with AI analytics, SSO, SLAs, and premium support.",
...
const comparison = [
  {
    ...
    rows: [
      {
        label: "Users",
        values: ["Limited", "Limited", "Unlimited", "Limited"],
      },
      {
        label: "Sites",
        values: [
          "Per site (pay‑as‑you‑go)",
          "Per site (pay‑as‑you‑go)",
          "Per site (pay‑as‑you‑go)",
          "Per site (pay‑as‑you‑go)",
        ],
    ...
    rows: [
      {
        ...
        values: [false, "Contact sales", "Contact sales", "Contact sales"],
      },
      {
        label: "ERP/CMMS integration",
        values: [false, "Contact sales", "Contact sales", "Contact sales"],
      },
      {
...
const modulePricing: ModulePrice[] = [
  {
    ...
    name: "intelliINSPECT",
    startsAt: 1249,
    blurb: "Digital inspection workflows",
  }, // ~$15k/year
  {
    id: "ndt",
    name: "intelliNDT",
    startsAt: 1699,
    blurb: "Non-destructive testing QA",
  }, // ~$20k/year
  {
    id: "integrity",
    name: "intelliINTEGRITY",
    startsAt: 2099,
    blurb: "Asset integrity & reliability",
  }, // ~$25k/year
  {
    id: "turn",
    name: "intelliTURN",
    startsAt: 1699,
    blurb: "Turnaround management",
  }, // ~$20k/year
  {
    id: "work",
    name: "intelliWORK",
    startsAt: 1249,
    blurb: "Crew management & workforce",
  }, // ~$15k/year
  {
    id: "track",
    name: "intelliTRACK",
    startsAt: 999,
    blurb: "Real-time asset tracking",
  }, // ~$12k/year
  {
    id: "comply",
    name: "intelliCOMPLY",
    startsAt: 849,
    blurb: "Automated compliance",
  }, // ~$10k/year
  {
    id: "command",
    name: "intelliSAFETY",
    startsAt: 1249,
    blurb: "Safety command & control",
  }, // ~$15k/year
  {
    id: "vault",
    name: "intelliSCAFF",
    startsAt: 699,
    blurb: "Scaffolding management",
  }, // ~$8k/year
  {
    id: "vision",
    name: "intelliVISION",
    startsAt: 2499,
    blurb: "Cross-module analytics",
  }, // ~$30k/year
];
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <p className="text-2xl text-slate-600 mb-8 leading-relaxed">
              intelliSPEC is designed for enterprise flexibility. Choose the
              modules you need, scale as you grow, and pay only for what you
              use. Pricing shown monthly; ROI calculated annually.
            </p>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-slate-600 text-lg">
              Monthly per‑site pricing with one‑time onboarding. Enterprise is
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 items-stretch">
            {plans.map((plan, idx) => (
              ...
              >
                <Card
                  className={`glass-morphism shadow-xl h-full border hover:-translate-y-1 hover:shadow-lg transition-all duration-300 ${plan.highlight ? "border-primary/30 bg-primary/5" : "border-slate-300/30"} flex flex-col`}
                >
                      ...
                      <div className="mb-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {plan.modules.map((module, moduleIdx) => (
                            <span
                              key={moduleIdx}
                              className="inline-flex items-center px-2 py-1.5 rounded-full text-xs font-semibold bg-secondary/10 text-secondary border border-secondary/20 hover:bg-secondary/15 transition-colors"
                            >
                              {module}
                            </span>
                          ))}
                    ...
                    <div className="mb-8 flex-1 min-h-[320px]">
                      ...
                      <div className="space-y-3">
                        {plan.roiHighlights.map((highlight, highlightIdx) => {
                          const Icon = [TrendingUp, Wallet, ShieldCheck, Timer][
                            highlightIdx % 4
                          ];
                          return (
                            <div
                              key={highlightIdx}
                              className="rounded-lg p-4 border border-[#54BAA0]/30 bg-[#54BAA0]/10"
                            >
                    ...
                    <div className="mt-auto">
                      {plan.priceLabel === "Contact Sales" ? (
                        <>
                          <Button
                            asChild
                            className="w-full bg-primary text-primary-foreground hover:opacity-90 hover:shadow-lg transition-all duration-200 text-sm font-medium py-3"
                          >
                        ...
                        <>
                          ...
                          <p className="mt-3 text-xs text-slate-600 text-center">
                            Need both inspection and planning?{" "}
                            <span className="text-[#54BAA0] font-medium">
                              Enterprise
                            </span>{" "}
                            combines all modules for maximum ROI.
                          </p>
                        </>
                      )}
                      {plan.priceLabel === "Contact Sales" && (
                        <p className="mt-3 text-xs text-slate-600 text-center">
                          Volume discounts and add-on modules available via{" "}
                          <span className="text-[#54BAA0] font-medium">
                            IntelliFlex
                          </span>{" "}
                          plan.
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-slate-600 mb-4">
              All plans include unlimited users, secure cloud hosting, and
              role-based access control.
            </p>
        ...
        <div className="container-custom">
          <div className="text-center mb-10">
            <h2 className="text-3xl lg:text-4xl font-bold mb-3">
              Build your Flex plan
            </h2>
            <p className="text-slate-600 text-lg">
              Pick modules and see your monthly per‑facility starts‑at estimate.
            </p>
          </div>
      ...
      <section className="py-20 bg-muted">
        <div className="container-custom">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-600 text-lg">
              A quick overview of what&apos;s included across Core, Edge,
              Enterprise, and Flex.
            </p>
          </div>
                ...
                <table className="min-w-[900px] w-full text-base">
                  <thead>
                    <tr className="bg-primary text-primary-foreground sticky top-0 z-10 shadow-sm">
                      <th
                        scope="col"
                        className="text-right py-3 px-4 font-semibold sticky left-0 z-20 bg-primary text-primary-foreground rounded-tl-2xl"
                      >
                        Feature
                      </th>
                      {comparisonColumns.map((c) => (
                        <th
                          key={c}
                          scope="col"
                          className="py-3 px-4 text-center font-semibold text-primary-foreground last:rounded-tr-2xl"
                        >
                          {c}
                        </th>
                      ))}
                  ...
                  <tbody>
                    {comparison.map((group, gIdx) => (
                      <React.Fragment key={group.title}>
                        <tr
                          className={`${gIdx > 0 ? "border-t-2 border-secondary/20" : ""}`}
                        >
                          <td
                            colSpan={comparisonColumns.length + 1}
                            className="pt-8 pb-3 px-4 text-sm font-semibold text-slate-500 uppercase tracking-wide"
                          >
                            <span className="inline-flex items-center gap-2">
                              {(() => {
                                const I = groupIconMap[group.title];
                                return I ? (
                                  <I className="w-4 h-4 text-secondary" />
                                ) : null;
                              })()}
                              {group.title}
                              {group.title === "Admin and support" && (
                                <span className="ml-2 text-[10px] px-2 py-0.5 rounded-full border border-secondary/30 bg-secondary/10 text-secondary normal-case">
                                  Support & Security
                                </span>
                              )}
                              {group.title === "Usage" && (
                        ...
                        {group.rows.map((row, rowIdx) => (
                          <tr
                            key={row.label}
                            className={`border-t border-slate-200/50 ${rowIdx % 2 === 0 ? "bg-card/40" : ""}`}
                          >
                            <th
                              scope="row"
                              className="py-3 px-4 text-right text-slate-900 text-sm md:text-base font-medium sticky left-0 z-10 bg-card/80 backdrop-blur"
                            >
                              {row.label}
                            </th>
                              ...
                              <td key={i} className="py-3 px-4 text-center">
                                {typeof val === "boolean" ? (
                                  val ? (
                                    <span title="Included">
                                      <CheckCircle
                                        className="w-5 h-5 text-emerald-500 inline-block"
                                        aria-label="Included"
                                      />
                                    </span>
                                  ) : (
                                  ...
                                  <span
                                    className={`text-sm md:text-base ${String(val).toLowerCase().includes("contact") ? "inline-flex items-center gap-2 text-secondary" : "text-slate-700"}`}
                                  >
                                    {String(val)
                                      .toLowerCase()
                                      .includes("contact") ? (
                                    ...
                                    {String(val)
                                      .toLowerCase()
                                      .includes("pay‑as‑you‑go") ||
                                    String(val)
                                      .toLowerCase()
                                      .includes("pay-as-you-go") ? (
                                      <span className="px-2 py-0.5 rounded-full border border-secondary/20 bg-secondary/5 text-secondary">
                                        {val}
                                      </span>
                                    ) : (
                                      val
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Built for enterprise-scale operations with the flexibility to meet
              your unique needs.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                icon: Settings,
                subtitle:
                  "Tailored product extensions delivered by senior engineers",
              ...
              },
              {
                ...
                icon: Briefcase,
                subtitle:
                  "Expert guidance from discovery to enterprise rollout",
              ...
              <Card
                key={card.title}
                className="glass-morphism h-full border border-slate-300/40 hover:border-primary/40 transition-colors"
              >
                <CardContent className="p-6">
                    ...
                    {card.badges && (
                      <div className="mt-2 flex flex-wrap gap-2">
                        {card.badges.map((b: string) => (
                          <span
                            key={b}
                            className="text-xs px-2 py-1 rounded-full border border-secondary/20 bg-secondary/5 text-secondary"
                          >
                            {b}
                          </span>
                        ))}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
                    <ul className="space-y-2">
                      {card.bullets
                        .slice(0, Math.ceil(card.bullets.length / 2))
                        .map((b: string) => (
                          <li
                            key={b}
                    ...
                    <ul className="space-y-2 mt-2 md:mt-0">
                      {card.bullets
                        .slice(Math.ceil(card.bullets.length / 2))
                        .map((b: string) => (
                          <li
                            key={b}
                            className="flex items-start gap-2 text-sm"
        ...
        <div className="container-custom">
          ...
          <div className="max-w-4xl mx-auto space-y-3">
            {faqs.map((f) => (
              <details
                key={f.q}
                className="group border border-slate-300/40 rounded-xl p-4 bg-card"
              >
...
function SimpleROI({
  ...
  const estimatedSavings = useMemo(() => {
    const perFacilitySavings = selected.reduce(
      (sum, id) => sum + (moduleValueMap[id] || 0),
      0
    );
    // Diminishing returns curve for many modules
    const diminishing =
      selected.length >= 6 ? 0.8 : selected.length >= 3 ? 0.9 : 1;
    return Math.round(
      perFacilitySavings * diminishing * Math.max(1, facilityCount)
    );
  ...
  const { annualCost, savings, discountRate } = useMemo(() => {
    ...
    const discountRate = bundleCount >= 6 ? 0.1 : bundleCount >= 2 ? 0.05 : 0;
    const discountedModules = Math.round(moduleSum * (1 - discountRate));
    const perFacilityMonthly = Math.max(
      FLEX_BASE_STARTS_AT + discountedModules,
      MIN_PER_FACILITY
    );
    ...
    const saved =
      Math.max(0, moduleSum - discountedModules) *
      Math.max(1, facilityCount) *
      12; // Annual savings
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div>
            ...
            <p className="text-slate-700 max-w-xl mt-2">
              Based on your Flex selection, this is a conservative annual
              savings estimate across your facilities. Actuals vary by
              workflows, data quality, and adoption.
            </p>
          </div>
        ...
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-4 gap-4 text-sm">
          ...
          <div className="rounded-xl bg-muted p-3 border border-slate-300/40">
            ...
            <div className="font-semibold">
              ${(estimatedSavings - annualCost).toLocaleString()}
            </div>
          </div>
          <div className="rounded-xl bg-muted p-3 border border-slate-300/40">
          ...
          <div className="rounded-xl p-3 border border-accent/30 bg-accent/10">
            <div className="text-accent flex items-center justify-between">
              ...
              {discountRate > 0 && (
                <span className="text-xs px-2 py-0.5 rounded-full border border-accent/40">
            ...
            <div className="mt-4 space-y-3 text-sm text-slate-700">
                ...
                <div className="space-y-2 text-xs">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      {(estimatedSavings - annualCost).toLocaleString()} =
                      Estimated Savings (${estimatedSavings.toLocaleString()}) -
              ...
              <div className="bg-card rounded-lg p-4 border border-border">
                ...
                <div className="space-y-2 text-xs">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <strong>Monthly cost per facility:</strong> $
                      {(
                        annualCost /
                        12 /
                        Math.max(1, facilityCount)
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      {annualCost.toLocaleString()} = Monthly cost × 12 months ×{" "}
                      {facilityCount}{" "}
              ...
              <div className="bg-card rounded-lg p-4 border border-border">
                ...
                <div className="text-xs">
                  Based on industry benchmarks and customer data, each module
                  contributes measurable savings. Your selected modules estimate{" "}
                  <strong className="text-accent">
                    ${estimatedSavings.toLocaleString()}/year
                  </strong>{" "}
                  in operational efficiency, reduced downtime, faster
                  inspections, and compliance automation.
                </div>
              </div>
              ...
              <div className="bg-warning/10 rounded-lg p-3 border border-warning/30">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-xs text-foreground/80">
                    <strong>Important:</strong> These are conservative
                    estimates. Actual ROI varies by facility size, current
                    processes, data quality, and adoption rates. Contact our
                    team for a customized ROI analysis based on your specific
                    operations.
                  </div>
                </div>
              </div>
        ...
        <CardContent className="p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-slate-600">
              Monthly pricing shown is &ldquo;starts at&rdquo; guidance. Final
              quotes may vary based on scale and scope.
            </p>
          </div>
            ...
            {modulePricing.map((m) => {
              ...
              return (
                <button
                  key={m.id}
                  onClick={() => toggle(m.id)}
                  className={`w-full text-left rounded-xl border px-4 py-3 transition ${active ? "border-primary/40 bg-primary/10" : "border-slate-300/30 bg-card hover:bg-muted/50"}`}
                  aria-pressed={active}
                >
      ...
      <Card className="glass-morphism animate-[fadeIn_0.6s_ease-out]">
        <CardContent className="p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-sm text-slate-600 flex items-center gap-2">
                ...
                Platform base (per facility)
              </span>
              <span className="font-medium">
                ${FLEX_BASE_STARTS_AT.toLocaleString()}
              </span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-slate-600 flex items-center gap-2">
            ...
            {totals.listPerFacility !== totals.perFacility && (
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-600">
                  List price (per facility)
                </span>
                <span className="font-medium line-through text-slate-400">
                  ${totals.listPerFacility.toLocaleString()}
                </span>
              </div>
            )}
            {totals.discountRate > 0 && (
              <div className="flex items-center justify-between text-accent">
                <span className="text-sm flex items-center gap-2">
                  ...
                  Discount per facility
                </span>
                <span className="font-medium">
                  -{Math.round(totals.discountRate * 100)}% ($
                  {totals.savingsPerFacility.toLocaleString()})
                </span>
              </div>
            )}
            <div className="flex items-center justify-between">
              <span className="text-sm text-slate-600">
                Per facility/month (starts at)
              </span>
              <span className="text-3xl font-bold">
                ${totals.perFacility.toLocaleString()}
              </span>
            </div>
            {totals.minFloorApplied && (
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-slate-500">
                  ${MIN_PER_FACILITY.toLocaleString()} min/month
                </span>
              </div>
            )}
            <div className="flex items-center justify-between">
              <label htmlFor="facilityCount" className="text-sm text-slate-600">
                Facilities
              </label>
              <input
                id="facilityCount"
            ...
            {totals.discountRate > 0 && (
              <div className="flex items-center justify-between border-t border-slate-300/30 pt-3">
                <span className="text-sm text-secondary">
                  Total module bundle savings
                </span>
                <span className="text-2xl font-bold text-secondary">
                  ${totals.savingsTotal.toLocaleString()}
                </span>
              </div>
            )}
            <div className="flex items-center justify-between border-t border-slate-300/30 pt-3">
              <span className="text-sm text-slate-600">
                Monthly estimate (starts at)
              </span>
          ...
          <p className="mt-3 text-xs text-slate-500">
            Estimates exclude taxes.{" "}
            {selected.length === 0
              ? `Minimum ${MIN_PER_FACILITY.toLocaleString()}/site/month applies.`
              : ""}{" "}
            Final pricing depends on scope, integrations, and SLAs.
          </p>
        </CardContent>
      </Card>
    </div>
