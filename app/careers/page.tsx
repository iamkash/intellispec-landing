  ...
  const companyBenefits = [
    {
      ...
      description:
        "Comprehensive health insurance, dental, vision, and wellness programs to keep you healthy and happy.",
      color: "bg-primary",
    },
    {
      icon: DollarSign,
      ...
      description:
        "Competitive salaries, 401(k) matching, stock options, and performance-based bonuses.",
      color: "bg-secondary",
    },
    {
      icon: Clock,
      ...
      description:
        "Flexible work arrangements, generous PTO, and remote work options to support your lifestyle.",
      color: "bg-accent",
    },
    {
      icon: GraduationCap,
    ...
    },
    {
      ...
      title: "Team Culture",
      description:
        "Collaborative environment, team events, and a supportive community of professionals.",
      color: "bg-secondary",
    },
    {
      icon: Rocket,
      title: "Innovation",
      description:
        "Work with cutting-edge technology and be part of transforming industrial safety.",
      color: "bg-accent",
    },
  ];
  ...
  const companyValues = [
    {
      ...
      title: "Safety First",
      description:
        "We prioritize safety in everything we do, both for our clients and our team members.",
    },
    {
      icon: Target,
      title: "Excellence",
    ...
    },
    {
      ...
      title: "Collaboration",
      description:
        "We believe in the power of teamwork and foster a collaborative work environment.",
    },
    {
      icon: Lightbulb,
      title: "Innovation",
      description:
        "We continuously innovate to solve complex industrial challenges with technology.",
    },
  ];
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto mb-8 leading-relaxed">
              Join a team of innovators, problem-solvers, and industry pioneers.
              Help us transform how industries approach safety and efficiency
              through our{" "}
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              We&apos;re not just building software—we&apos;re building a safer,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Every line of code you write, every feature you build, directly
                contributes to making industrial workplaces safer. Our{" "}
                <span className="text-primary font-semibold">
                  10 integrated modules
                </span>{" "}
                help prevent accidents, save lives, and protect workers across
                multiple industries.
              </p>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Your work directly prevents workplace accidents and
                      injuries
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Work with cutting-edge technology in industrial IoT and
                      safety
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Your solutions impact workers across multiple countries
                      and industries
                    </p>
                  </div>
                </div>
              ...
              <Card className="glass-card shadow-2xl p-8">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Join us at an exciting time of rapid growth and expansion.
                    Your contributions will shape the future of our platform and
                    company.
                  </p>
                ...
                <Card className="glass-card shadow-xl hover:shadow-2xl transition-all duration-300 h-full">
                  <CardContent className="p-8 h-full flex flex-col">
                    {(() => {
                      ...
                      return (
                        <div
                          className={`w-16 h-16 ${s} rounded-2xl flex items-center justify-center mb-6 shadow-lg`}
                        >
            ...
            <Card className="glass-card shadow-2xl hover:shadow-3xl transition-all duration-300">
              <CardContent className="p-12 text-center">
                ...
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed max-w-2xl mx-auto">
                  We use ADP Workforce Now to manage our recruitment process.
                  Click below to access our official job portal where you can
                  browse all current openings, submit applications, and track
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    You&apos;ll be redirected to our secure ADP Workforce Now
                    recruitment portal
                  </p>
                </div>
              </CardContent>
      ...
      <section className="section-padding">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Our simple and transparent application process ensures you have
              the best experience.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Meet with our team through technical and cultural fit interviews.",
                icon: Users,
              },
              {
                step: "04",
                ...
                description:
                  "Receive your offer and join our team with a comprehensive onboarding program.",
                icon: Award,
              },
            ].map((step, index) => (
              <motion.div
        ...
        <div className="container-custom text-center">
          ...
          >
            ...
            <p className="text-xl text-primary-foreground/80 mb-8 max-w-3xl mx-auto">
              Don&apos;t see the perfect role? Send us your resume and
